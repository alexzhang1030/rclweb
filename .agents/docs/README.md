...
| Runtime images, operations endpoints, `ros2 run`, systemd, and apt | [Deploy](../../docs/deploy.md), [`ros2 run`](../../docs/deploy.md#ros2-run), [systemd](../../docs/deploy.md#systemd), [apt](../../docs/deploy.md#apt), [ADR 0019](../../docs/adr/0019-own-apt-repository.md) |
...
| `scripts/apt-*.ts`, `scripts/pack-rclwebd-deb.ts`, `scripts/pack-rclweb-apt-source.ts`, `scripts/publish-apt-repo.ts` | Own apt repo: `rclwebd` + `rclweb-apt-source`, Signed-By keyring, noble/jammy ([ADR 0019](../../docs/adr/0019-own-apt-repository.md), [deploy](../../docs/deploy.md#apt), [gotchas](./gotchas.md#own-apt-is-signed-by-not-bloom)) |
