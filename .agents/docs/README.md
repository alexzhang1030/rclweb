...
| Runtime images, operations endpoints, `ros2 run`, and systemd units | [Deploy](../../docs/deploy.md), [`ros2 run`](../../docs/deploy.md#ros2-run), [systemd](../../docs/deploy.md#systemd) |
...
| `scripts/install-rclwebd-ament.sh`, `packaging/ament/rclwebd/**` | Thin ament overlay for `ros2 run rclwebd rclwebd`. Not apt / cargo-in-colcon ([ADR 0018](../../docs/adr/0018-prebuilt-gateway-distribution.md), [deploy](../../docs/deploy.md#ros2-run)). `ros2 run` does not wrap `setup.bash` ([gotchas](./gotchas.md#ros2-run-already-has-a-sourced-prefix)) |
