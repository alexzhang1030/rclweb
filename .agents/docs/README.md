...
| `typescript/src/cdr-le.ts` | Host-retain String / PointCloud2 decode; String is a direct LE read (no `CdrLeReader`); `data` is a view of the WS / transferred buffer ([ADR 0017](../../docs/adr/0017-host-retain-inbound-sample-payload.md)) |
