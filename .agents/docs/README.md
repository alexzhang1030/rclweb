...
| `.github/workflows/delete-unused-branches.yml` | Closes leftover GitHub heads after a PR closes and sweeps abandoned branches after 14 days ([CONTRIBUTING](../../CONTRIBUTING.md#unused-branches), [validation](../../docs/validation.md#foundation-ci)). Never deletes `main`. |
